...
let ca = 0
    ...
    const buttonSTR = document.querySelector('.start');
    buttonSTR.addEventListener('click',function handleClick() {
...
let barea = document.querySelector('.barea')

console.log(window.screen.availHeight)
console.log(window.screen.availWidth)

if (window.screen.availHeight < 800  && window.screen.availWidth < 1400){
    barea.style.width = '600px'
    barea.style.height = '600px'
    field.height = 600
    field.width = 600 
}
